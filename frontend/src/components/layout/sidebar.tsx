    ...
    <>
      ...
      <aside
        className={cn(
          ...
          isMobile
            ? sidebarCollapsed
              ? "-translate-x-full w-70 opacity-0"
              : "translate-x-0 w-70 opacity-100"
            : sidebarCollapsed
              ? "w-14"
              : "w-65",
        )}>
        <div className="flex-1 overflow-y-auto py-3 px-2 space-y-4">
            ...
            {MAIN_NAV.map((item) => {
              ...
              return (
                <Link
                  ...
                  <Icon
                    size={16}
                    className={cn(isActive && "text-brand-400", "shrink-0")}
                  />
          ...
          <div className="space-y-0.5">
            {(!sidebarCollapsed || isMobile) && (
              <p className="px-2.5 text-[10px] font-semibold uppercase tracking-wider text-text-muted mb-1">
                Account
              </p>
            )}
