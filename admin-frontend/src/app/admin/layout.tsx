...
export default function AdminLayout({
  ...
  return (
    <div className="h-screen flex bg-bg-primary overflow-hidden">
      ...
      <aside
        className={cn(
          "flex flex-col border-r border-border-primary bg-bg-secondary transition-all duration-200 shrink-0",
        ...
        <div className="border-t border-border-primary p-2 space-y-1">
          ...
          <button
            ...
            className={cn(
              "flex items-center gap-2.5 w-full px-2.5 py-1.5 rounded-lg text-xs text-accent-rose hover:bg-accent-rose/10 transition-colors cursor-pointer",
              sidebarCollapsed && "justify-center px-0",
            )}>
            <LogOut size={14} />
          ...
          <button
            ...
            className={cn(
              "flex items-center gap-2.5 w-full px-2.5 py-1.5 rounded-lg text-xs text-text-muted hover:text-text-primary hover:bg-white/[0.03] transition-colors cursor-pointer",
              sidebarCollapsed && "justify-center px-0",
            )}>
            <PanelLeftClose
              size={14}
